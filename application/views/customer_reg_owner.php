        ...
        <section class="content pt-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-success" onclick="add_user()"><i class="glyphicon glyphicon-plus"></i> Add Customer</button>
...
var url;
if(save_method == 'add'){
    url = "<?php echo site_url('main/user_customer_add')?>";
}
else{
...
$('#form')[0].reset(); // reset form on modals
    ...
    $.ajax({
        url : "<?php echo site_url('main/ajax_edit_user_customer/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data){
