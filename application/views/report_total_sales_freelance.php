                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <!--<table style="width:100%;" border="1">-->    
                                <tr>
                                    <td class="bg-info text-white">Customer Name</td>
                                ...
                                <tbody id="table_body" name='table_body'> 
                                    ...
                                    for($i = 0; $i < count($reportsData); $i++){
                                      ...
                                      if($temp != $row['res_id'] || $i == 0){
                                        ...
                                        echo "<td style='color:white'>".'Labor Amount'."</td>";
                                    ...
                                    echo "<tr>"; 
                                    echo "<td colspan='2' style='font-size:15pt;font-weight:bold'>".'Total Sales'."</td>";
                                    echo "<td>".''."</td>";
