<div class="container-fluid">
    <section class="content pt-4">
        ...
        <h1 style="color:green;font-weight: bold;"><?php echo $this->session->shopname ?></h1>
                    ...
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select style='height:40px; width: 100%' class="form-control" name="branch_name" id="branch_name">
                                        <option value="">--Choose Branch--</span>
                                        <?php
                                          foreach($branchOwnerData as $key=>$branch){
                                          echo "<option value='".$branch['branch_id']."'>".$branch['branch_name']."</span>";
                                          }
                                        ?>
                                        </option>
                                    </select> 
