        ...
        <section class="content pt-2">
            <div class="card">
                <div class="card-header">
                        <h3 class="card-title text-muted">Labor</h3>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <table id="mytable" class="table table-sm table-striped nowrap">
                                <thead>
                                    <tr>
                                        <th class="bg-info text-white">Service Name</th>
                                        <th class="bg-info text-white">Labor Amount</th>
                ...
                <div class="modal-body form" >
                    <form action="#" id="form" class="form-horizontal">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Labor Amount:</label>
                                <div class="col-md-9">
...
if(save_method == 'add'){
    url = "<?php echo site_url('main/service_freelance_add')?>";
}
else{
